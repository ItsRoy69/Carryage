  ...
  return (
    <View style={styles.VerifyNum}>
      ...
      <View style={styles.frameParent}>
        <View>
          <Text style={[styles.createVerify, styles.carryageTypo]}>
            Verify your phone
          </Text>
          <Text style={styles.createASafe}>
            Please enter the code that we have just sent you on your phone number.
          </Text>
        </View>
        <View style={styles.inputField}>
          <View style={styles.inputFieldBase}>
            <View style={styles.inputFieldBase}>
              <Text style={[styles.label, styles.textTypo1]}>Code</Text>
