  ...
  return (
    <View style={styles.Login}>
      ...
      <View style={styles.button}>
        <TouchableOpacity onPress={() => navigation.navigate("Home")} style={styles.buttonBase}>
          <Text style={[styles.text, styles.textTypo1]}>Login</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.frameParent}>
        ...
        <View style={styles.inputField}>
          <View style={styles.inputFieldBase}>
            <View style={styles.inputFieldBase}>
              <Text style={[styles.label, styles.textTypo1]}>Email</Text>
              <TextInput placeholder="olivia@untitledui.com" style={[styles.input, styles.inputSpaceBlock]} />
            </View>
